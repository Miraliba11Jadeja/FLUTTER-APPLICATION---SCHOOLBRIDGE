...
class HolidayAdminScreen extends StatefulWidget {
  @override
  _HolidayAdminScreenState createState() => _HolidayAdminScreenState();
}

class _HolidayAdminScreenState extends State<HolidayAdminScreen> {
      ...
      FirebaseFirestore.instance
        ...
        final data = snapshot.docs
            .map((doc) {
              ...
              String? name =
                  doc.data().containsKey('Name') ? doc['Name'] : null;
              String? date =
                  doc.data().containsKey('Date') ? doc['Date'] : null;
